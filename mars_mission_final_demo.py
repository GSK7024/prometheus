#!/usr/bin/env python3
"""
Mars Mission Control System - Final Demo
...
class AerospaceEngineeringModule:
    ...
    def _calculate_launch_azimuth(self, launch_site, target_orbit):
        ...
        # Ensure the argument is within valid range for asin
        cos_inc = math.cos(math.radians(inclination))
        cos_lat = math.cos(math.radians(launch_lat))
        argument = cos_inc / cos_lat

        # Clamp to valid range [-1, 1]
        argument = max(-1.0, min(1.0, argument))

        azimuth = math.asin(argument)
